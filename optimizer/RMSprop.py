...
class RMSprop(object):
    def __init__(self, parameters, lr=0.001, rho=0.9, gamma=0.9999, method='fixed', min_lr=1e-10):
        self.lr = lr
        self.gamma = gamma
        self.method = method
        self.step = 0
    ...
    def update_parameter(self, w, dw, batch_size, obj_id, index):
        ...
        self.g[obj_id][index] = 2 * self.rho * self.g[obj_id][index] + (1 - self.rho) * np.square(dw)
        self.step += 1
